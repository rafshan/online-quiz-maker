...
@section('content')
<body style="background-color: #daf4f4">
    <div class="container">
  		...
  		@foreach($questions as $question)
            <div class="">
                <form method="get" action="/makequestion/{{$question->id}}/edit" class="ansform">
                    ...
                    <button type="submit" name="submitFromEditPage" class="btn btn-primary btn-md edit_data  btn-lg align-center btn-block">Edit</button>
                 </form>
            </div><br>
         @endforeach

<a href="/"><button type="button" name="ReviewDone" class="btn btn-success btn-block">Review Done</button></a><br><br>
