...
@section('content')
<body style="background-color: #d8dfe5">
    <div>
        ...
        <h1 class="col-lg-offset-4" style="color: red;"><span style="color: #e94a49"><b>  Quiz on: {{$course}}  </b></span></h1>
        <div class="col-md-6 col-lg-6 col-sm-6 col-lg-offset-3" style="background-color: #f0f8ff">
            ...
            <div class="col-md-6 col-lg-8 col-sm-6 col-lg-offset-2">
                <form method="post" action="{{route('answer.store')}}" class="ansform">
                    ...
                    <div class="col-lg-offset-1">
                        ...
                        <input type="submit" name="submit" value="submit" class="btn btn-primary" id="submitbtn"><br>
                    </div>
                 </form>
            </div>
         @endforeach
...
<br><a href="/"><button type="button" name="Return" class="btn btn-success">I'm Done!</button></a><br><br>
        </div>
